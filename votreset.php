<!-- PHP page for password reset for voter -->
...
<?php
  ...
  if($newpass == $repass)
  {
  $sql = "UPDATE `voterlogin` SET `pass`= '$newpass' WHERE `adhaarno` = '$adhaar' AND `pass` = '$pass'"; 
...
<body>
	<form method="POST" action="votreset.php">
  <div class="container">
    ...
    <button type="button" class="back" onclick="location.href='votsettings.php'">Back</button>
</div>
    <?php
       ...
       {?>
        <script type="text/javascript">
         alert($message);
         window.location.href = "votreset.html";
       </script>
       <?php
       }
    ?>
