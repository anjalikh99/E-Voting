   ...
   function initializeContract() {
     ...
     if (typeof window.web3 !== 'undefined') 
        ...
        else 
        {
         ...
         return new web3.eth.Contract(CandidateABI, "0x6c4f87445934a3d2c4be069b02ea10dc26d4a006");
  ...
  async function getDetails() {
    ...
    accounts = await ethereum.request({ method: 'eth_requestAccounts' });
         ...
         try {
          ...
          CandContract.methods.voternum().call({from : accounts[0]}).then(function(result){
              document.getElementById("vote").innerHTML = result;  
          });

          //get total number of voters voted
          CandContract.methods.voterVoted().call({from : accounts[0]}).then(function(result){
